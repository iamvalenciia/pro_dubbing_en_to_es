...
class EdgeTTS(BaseTTS):
    ...
    async def _exec(self) -> None:
        ...
        for it in self.queue_tts:
            ...
            # Si get_edge_rolelist retorna None, usar el role original o un default
            it['role'] = role if role else (it['role'] if isinstance(it['role'], str) and 'Neural' in it['role'] else 'en-US-AriaNeural')
            #print(f'{it["role"]=}')
